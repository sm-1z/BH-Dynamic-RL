...
class CassieEnv(MujocoEnv, utils.EzPickle):
    ...
    * v0: Initial versions release (1.0.0)
    ...
    def step(self, action):
        ...
        x_velocity, y_velocity, _ = xyz_velocity
        ...
        # print(f"control_torque={control_torque:.2f}")
        ...
        info = {
            ...
            "distance_from_origin": np.linalg.norm(xyz_position_after[0:2], ord=2),
